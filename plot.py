...
RUNS = [
    {"name": "Baseline", "color": "blue", **get_data_from_file(ROOT / "experiment_logs/20250523_Baseline30k.txt")},
    {"name": "ROracle", "color": "green", **get_data_from_file(ROOT / "experiment_logs/20250523_ROracle30k.txt")},
]
